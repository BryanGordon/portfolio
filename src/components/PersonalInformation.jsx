...
export function PersonalInformation () {
  /* Cambiar todos los labels por span
    - Cambiar estructura de los label > p (Sacar los p de dentro de los label)
    - Cambiar estructura de los label con bloques, sacandoloes del label y colocando
      un contenedor aparte con el resto de informacion
  */
  return (
